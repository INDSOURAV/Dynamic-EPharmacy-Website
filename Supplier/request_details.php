         ...
         <div style=" box-shadow: 0px 0px 15px 0px #D6D6D6;padding-left:80px;padding-bottom:160px;padding-top:160px;padding-right:80px;margin-bottom:15px;margin-top:15px;width:100%;height: 50%; ">
             ...
             <table class="timetable_sub" style="border : 1px solid #cdcdcd;">
                            <thead>
                             ...
                             <tbody>
            <?php
                $query = mysqli_query($connect,"SELECT * FROM order_mst WHERE by_id = '{$user_id}' AND (type='Req' OR o_status='Rejected' OR o_status='Cancelled') order by order_date_time DESC");
                $i=0;
            ...
            ?>
                		...
                		<tr>
                                    ...
                                    <td><?php echo "<a href='request_details_1.php?oid={$result['ord_id']}'>Details </a>"?></td>
                                </tr>
