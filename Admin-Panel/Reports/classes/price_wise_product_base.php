...
/**
 * Table class for price wise product
 */
class price_wise_product_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		$this->TableVar = 'price_wise_product_base';
		$this->TableName = 'price wise product';
		$this->TableType = 'VIEW';
		...
		// price
		$this->price = new ReportField('price_wise_product_base', 'price wise product', 'x_price', 'price', '`price`', 4, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->price->Lookup = new ReportLookup('price', 'price_wise_product_base', TRUE, 'price', ["price","","",""], [], [], [], [], [], [], '`price` ASC', '');
		$this->price->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['price'] = &$this->price;

		// pro_name
		$this->pro_name = new ReportField('price_wise_product_base', 'price wise product', 'x_pro_name', 'pro_name', '`pro_name`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pro_name->Sortable = TRUE; // Allow sort
		$this->pro_name->DateFilter = "";
		$this->fields['pro_name'] = &$this->pro_name;

		// qty
		$this->qty = new ReportField('price_wise_product_base', 'price wise product', 'x_qty', 'qty', '`qty`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->_sqlFrom <> "") ? $this->_sqlFrom : "`price wise product`";
	}
