...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'f0CMXdseivrnfYj0'); // Random key for encryption
...
$PROJECT_ID = "{BF56CB4E-8D46-4657-9DE9-A2FB7BFB0371}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "e-pharmacy", "qs" => "`", "qe" => "`");
